...
<div class="sidebar animate__animated animate__fadeInLeft">
  <h4 class="text-center">Espace Élève</h4>
  <hr>
...
<div class="content animate__animated animate__fadeIn">
  <h2>Bienvenue, 👋</h2>
  <p>Voici vos informations scolaires :</p>
  ...
  <div class="row mt-4">
    <div class="col-md-6 mb-3">
      <div class="card shadow-sm animate__animated animate__fadeInUp">
        <div class="card-body">
          ...
          <p class="card-text">Consultez vos résultats scolaires et bulletins.</p>
          <a href="notes_bulletins.php" class="btn btn-custom">Voir les notes</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 mb-3">
      <div class="card shadow-sm animate__animated animate__fadeInUp animate__delay-1s">
        <div class="card-body">
          <h5 class="card-title"><i class="bi bi-calendar-event"></i> Calendrier</h5>
          <p class="card-text">Accédez aux examens et événements scolaires.</p>
    ...
    <div class="col-md-6 mb-3">
      <div class="card shadow-sm animate__animated animate__fadeInUp animate__delay-2s">
        <div class="card-body">
          ...
          <p class="card-text">Suivez vos absences et remarques des enseignants.</p>
          <a href="suivi_absences.php" class="btn btn-custom">Suivre</a>
        </div>
      </div>
    </div>
  </div>
